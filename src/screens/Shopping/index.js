...
const FLIGHT_IMAGE = "../../../assets/Icons/App/Shopping/flight.png";
const BUS_IMAGE = "../../../assets/Icons/App/Shopping/bus.png";
const TRAIN_IMAGE = "../../../assets/Icons/App/Shopping/train.png";
const SUNSET_IMAGE = "../../../assets/Icons/App/Shopping/sunset.png";
const MICROPHONE_IMAGE = "../../../assets/Icons/App/Shopping/microphone.png";
const CLAPPERBOARD_IMAGE =
  "../../../assets/Icons/App/Shopping/clapperboard.png";
          ...
          if (!cardNumberErrorAmount && !cardNumberErrorCard) {
            ...
            axios
              ...
              .catch(error => {
                this.setState({ isRequestingToServer: false });
                console.log(
                  "For use this services you must connect to internet",
                  error
                );
              });
          }
      ...
      return (
        <View style={styles.buttonContainer}>
          <Button
            ...
            onPress={() => this.goToAnotherScreen(selectedType)}
        ...
        <Content padder>
          ...
          <View style={styles.chargeMethodsCard}>
            ...
            <View style={styles.chargeMethodsContainer}>
              ...
              >
                <TouchableOpacity
                  onPress={() => this.onSelectMethod(4)}
                  style={styles.cardNumberContainer}
                >
                  <Image
                    source={require(SUNSET_IMAGE)}
                    style={styles.cardNumberImage}
                    resizeMode="contain"
                  />
                  <Text allowFontScaling={false} style={styles.cardNumberText}>
                    {I18n.t("Shopping.sunset")}
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              >
                <TouchableOpacity
                  onPress={() => this.onSelectMethod(5)}
                  style={styles.chargeCenterContainer}
                >
                  <Image
                    source={require(MICROPHONE_IMAGE)}
                    style={styles.chargeCenterImage}
                    resizeMode="contain"
                  />
                  <Text
              ...
              >
                <TouchableOpacity
                  onPress={() => this.onSelectMethod(6)}
                  style={styles.peopleContainer}
                >
                  <Image
                    source={require(CLAPPERBOARD_IMAGE)}
                    style={styles.peopleImage}
                    resizeMode="contain"
                  />
                  <Text allowFontScaling={false} style={styles.peopleText}>
                    {I18n.t("Shopping.cinema")}
                  </Text>
                </TouchableOpacity>
              </View>
            </View>
